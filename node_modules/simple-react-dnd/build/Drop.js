  ...
  return function dragAndDropWrapper(WrappedComponent) {
    var Drop = function (_Component) {
      ...
      function Drop() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Drop.__proto__ || Object.getPrototypeOf(Drop)).call.apply(_ref, [this].concat(args))), _this), _this.handleDragOver = function (e) {
          e.preventDefault();
